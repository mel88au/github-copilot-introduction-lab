      ...
      Object.entries(activities).forEach(([name, details]) => {
        ...
        activityCard.querySelectorAll(".delete-participant").forEach((button) => {
          button.addEventListener("click", async (event) => {
            ...
            const activity = encodeURIComponent(decodeURIComponent(clickedButton.dataset.activity));
            const participant = encodeURIComponent(decodeURIComponent(clickedButton.dataset.participant));
